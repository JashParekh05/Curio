...
export default function BottomNav() {
  ...
  // "/" matches exactly; Learn also covers the /feed destinations that the
  // structured/basic modes (and the Discover "Learn" cross-link) route into;
  // the rest match by prefix.
  const isActive = (href: string) => {
    if (href === "/") return pathname === "/";
    if (href === "/learn") return pathname.startsWith("/learn") || pathname.startsWith("/feed");
